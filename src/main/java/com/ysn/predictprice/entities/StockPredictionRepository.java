...
public interface StockPredictionRepository extends JpaRepository<StockPrediction, Long> {
    @Query(value = "SELECT predict_date,s.ticker,accuracy,ci.company_name as company_name,consensus,predict_time,prediction_today,price_yesterday,predicted_change_rate,yesterday_date,status\n" +
            ...
            "WHERE s.ticker!='GOOGL' and s.ticker!='AMZN' and s.ticker!='AAPL' and s.ticker!='MSFT' and s.ticker!='TSLA' and s.ticker!='NVDA' and s.ticker!='PEP' and s.ticker!='AVGO' and s.ticker!='AZN' and s.ticker!='COST' and s.ticker!='CSCO' and s.ticker!='ADBE' and s.ticker!='CMCSA' and s.ticker!='TXN' and s.ticker!='AMGN' and s.ticker!='NFLX' and s.ticker!='QCOM' and s.ticker!='SNY' and s.ticker!='INTU' and s.ticker!='PDD' and s.ticker!='INTC' and s.ticker!='GILD' and s.ticker!='ADP' and s.ticker!='AMAT'\n"
            , nativeQuery = true)
